...
def feedforward(filename):
    ...
    model.add(keras.layers.Dense(400, activation="relu", input_shape=(inputShape,)))   
   ...
   # model.add(keras.layers.Dense(1000, activation="relu"))
    ...
    #f1_score =  2 * (metrics[2] * metrics[3]) / (metrics[2] + metrics[3]) #Built in f1_score function doesnt work...
    print(metrics)
